...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'watchdog_node = robot_pkg.watchdog_node:main',
            'patrol_node = robot_pkg.patrol_node:main',
            'map_manager_node = robot_pkg.map_manager_node:main',
            'follow_me_node = robot_pkg.follow_me_node:main',
